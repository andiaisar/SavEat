// andiaisar/saveat/SavEat-0aebf4ca14c8e3c387ff043acb369607ffc30613/app/src/main/java/com/example/saveat/database/DatabaseHelper.java
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final int DATABASE_VERSION = 4; // Versi database dinaikkan

    // Definisi tabel dan kolom pengguna
    private static final String TABEL_USERS = "users";
    private static final String COLUMN_ID = "id";
    private static final String COLUMN_USERNAME = "username";
    private static final String COLUMN_PASSWORD = "password";
    private static final String COLUMN_EMAIL = "email";
    private static final String COLUMN_GENDER = "gender"; // Kolom baru
    private static final String COLUMN_PROFILE_IMAGE_PATH = "profile_image_path"; // Kolom baru

    // Definisi tabel dan kolom bahan
    ...
    // Statement pembuatan tabel pengguna yang diperbarui
    ...
    // Statement pembuatan tabel bahan
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        if (oldVersion < 4) {
            // Menambahkan kolom baru ke tabel pengguna jika upgrade dari versi < 4
    ...
    public long adduser(String username, String password, String email) {
        ...
        // Nilai default untuk pengguna baru
